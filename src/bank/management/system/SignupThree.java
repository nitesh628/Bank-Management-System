...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        submitt.setBackground(Color.BLACK);
        submitt.setForeground(Color.WHITE);
        submitt.setFont(new Font("Raleway", Font.BOLD, 14));
        submitt.setBounds(250, 720, 100, 30);
