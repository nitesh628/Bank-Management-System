...
public class FastCash extends JFrame implements ActionListener {
    ...
    this.pinnumber = pinnumber;
        ...
        balanceEnquiry.setBounds(355, 520, 150, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == back) {
           ...
           new Transactions(pinnumber).setVisible(true);
            ...
            Conn c = new Conn();
            try{
            ResultSet rs = c.s.executeQuery("select * from where pin = '"+pinnumber+"'");
            int balance = 0;
            ...
            if(ae.getSource() != back && balance < Integer.parseInt(amount)){ // checking balance
